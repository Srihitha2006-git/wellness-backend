...
|---|---|---|
| `AuthController` | `/api/auth` | ✅ Complete |
...
| Service | Status |
|---|---|
| `AuthService` | ✅ Register, login, JWT, password reset |
...
| `TherapySessionService` | ✅ Book, cancel, reschedule, slot calc |
| `SessionNotificationService` | ✅ Notification + WebSocket push |
| `SessionReminderScheduler` | ✅ 30-min + 1-hour auto-reminders |
...
| Model | Notes |
|---|---|
| `User` | PATIENT / PRACTITIONER / ADMIN roles |
...
| `TherapySession` | full session lifecycle |
...
| Page | Route | Status |
|---|---|---|
| `Register.jsx` | `/register` | ✅ Complete |
...
| `PractitionerDashboard.jsx` | `/practitioner/dashboard` | ✅ Complete (large, multi-section) |
| `UserDashboard.jsx` | `/user/dashboard` | ✅ Complete (large, multi-section) |
...
| `NotificationDropdown.jsx` | Bell icon + notification list | ✅ Complete |
...
|---|---|---|
| `NotificationContext.jsx` | Global unread count + polling | ✅ Complete |

### Services (9)
| Service | Purpose | Status |
|---|---|---|
| `authService.js` | Register, login, refresh, password reset | ✅ Complete |
| `sessionService.js` | Book, cancel, reschedule, slots | ✅ Complete |
| `notificationService.js` | Fetch, mark-read, unread count | ✅ Complete |
...
| `websocketService.js` | STOMP connection lifecycle | ✅ Complete |
...
- `meeting_link` column exists in `therapy_session` table ✅
- **Backend**: No Jitsi / Zoom / WebRTC integration
- **Frontend**: No in-app video call
- **Impact**: Online sessions rely on an external link being manually set
